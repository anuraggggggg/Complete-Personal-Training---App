...
class _WalkThroughScreenState extends State<WalkThroughScreen> {
  static const bool showRegisterAfterWalkThrough = true;
  ...
  void _finishWalkThrough() {
    ...
    if (showRegisterAfterWalkThrough) {
        ...
        body: Stack(
          children: [
            Positioned(
              ...
              child: Image.asset(ic_walk_shape,
                ...
                return Column(
                  children: [
                    Image.asset(mWalkList[mCurrentIndex].image!,
                        height: context.height() * 0.55, fit: BoxFit.fill),
                  ],
