...
class _EditProfileScreenState extends State<EditProfileScreen> with TickerProviderStateMixin {
  ...
  sendMultiPartRequest(
    ...
    onSuccess: (data) async {
      final res = UserResponse.fromJson(jsonDecode(data));

      /// 🔥 UPDATE STORE (THIS AUTO REFRESHES PROFILE SCREEN)
      await userStore.setUserImage(
        res.data?.profileImage.validate() ?? '',
      );
            ...
            SingleChildScrollView(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration:
                      boxDecorationWithRoundedCorners(borderRadius: radiusOnly(topRight: 16, topLeft: 16), backgroundColor: appStore.isDarkMode ? context.scaffoldBackgroundColor : const Color.fromARGB(255, 29, 29, 29)),
                ),
                Column(children: [
                  16.height,
                  Stack(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<GenderModel>(
                        ...
                        isExpanded: false,
                        initialValue: GenderList.isNotEmpty ? GenderList[selectGender] : null,
                        isDense: true,
                        borderRadius: radius(),
                        decoration: defaultInputDecoration(context),
                      ...
                      16.height,
                      Text(languages.lblWorkoutLevel, style: secondaryTextStyle()),
                      4.height,
                      DropdownButtonFormField<int>(
                        ...
                        decoration: defaultInputDecoration(context),
                        hint: Text(languages.lblWorkoutLevel, style: primaryTextStyle()),
                        items: mLevelList.map((e) {
